...
namespace MovieAPI.Controllers
{
    ...
    public class LoginController : ControllerBase
    {
        ...
        public LoginController(IConfiguration config, MovieContext context)
        {
        ...
        {
            if (_userData != null && _userData.UserEmail != null && _userData.Password != null && _userData.Role != null)
            {
